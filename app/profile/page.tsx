...
import { Card, CardBody, CardHeader, Progress, Avatar, Button } from '@heroui/react';
import { motion } from 'framer-motion';
import { User, Calendar, Award, TrendingUp, BookOpen, Target } from 'lucide-react';
...
export default function UserDetailPage() {
  ...
  const memberSince = new Date(userProfile.joinedDate).toLocaleDateString('en-US', {
    month: 'long',
    year: 'numeric',
  });
  ...
  return (
    <Layout>
      <main className="min-h-screen bg-gray-50 p-4 md:p-8" role="main" aria-label="User profile">
                    ...
                    <div className="flex justify-between items-start w-full">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-gray-900">
                          {course.completedArticles}/{course.totalArticles} articles
                        </p>
                      </div>
                    </div>
                  </CardHeader>
